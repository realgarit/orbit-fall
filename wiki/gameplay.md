...
> **Tips, strategies, and how to actually play the game well.**
...
|:-------|:------|:-------------|
| 🎯 **Move ship** | Click and hold | Ship moves toward mouse cursor |
...
Your ship rotates toward your mouse cursor. Click and hold to move forward in that direction.
...
1. 👾 Find an enemy (Drifters are common)
2. 🎯 Double-click to target it
3. 🔫 Lasers auto-fire
4. 💣 Press spacebar for rockets if needed
5. 💀 Kill or run away
